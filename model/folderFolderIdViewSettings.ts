...
export class FolderFolderIdViewSettings {
    'collapseEmptyColumns'?: any | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "collapseEmptyColumns",
            "baseName": "collapse_empty_columns",
            "type": "any"
        },
        {
            "name": "meChecklists",
            "baseName": "me_checklists",
            "type": "boolean"
        },
        {
            "name": "meComments",
            "baseName": "me_comments",
            "type": "boolean"
        },
        {
            "name": "meSubtasks",
            "baseName": "me_subtasks",
            "type": "boolean"
        },
        {
            "name": "showAssignees",
            "baseName": "show_assignees",
            "type": "boolean"
        },
        {
            "name": "showClosedSubtasks",
            "baseName": "show_closed_subtasks",
            "type": "boolean"
        },
        {
            "name": "showImages",
            "baseName": "show_images",
            "type": "boolean"
        },
        {
            "name": "showSubtaskParentNames",
            "baseName": "show_subtask_parent_names",
            "type": "boolean"
        },
        {
            "name": "showSubtasks",
            "baseName": "show_subtasks",
            "type": "number"
        },
        {
            "name": "showTaskLocations",
            "baseName": "show_task_locations",
            "type": "boolean"
        }    ];

    static getAttributeTypeMap() {
        return FolderFolderIdViewSettings.attributeTypeMap;
    }
}
