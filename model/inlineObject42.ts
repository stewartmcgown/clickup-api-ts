...
import { FolderFolderIdViewColumns } from './folderFolderIdViewColumns';
import { FolderFolderIdViewDivide } from './folderFolderIdViewDivide';
import { FolderFolderIdViewFilters } from './folderFolderIdViewFilters';
import { FolderFolderIdViewGrouping } from './folderFolderIdViewGrouping';
import { FolderFolderIdViewSettings } from './folderFolderIdViewSettings';
import { FolderFolderIdViewTeamSidebar } from './folderFolderIdViewTeamSidebar';
import { ViewViewIdParent } from './viewViewIdParent';

export class InlineObject42 {
    'columns'?: FolderFolderIdViewColumns;
    'divide'?: FolderFolderIdViewDivide;
    'filters'?: FolderFolderIdViewFilters;
    'grouping'?: FolderFolderIdViewGrouping;
    'name'?: string;
    'parent'?: ViewViewIdParent;
    'settings'?: FolderFolderIdViewSettings;
    'sorting'?: FolderFolderIdViewColumns;
    'teamSidebar'?: FolderFolderIdViewTeamSidebar;
    'type'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "columns",
            "baseName": "columns",
            "type": "FolderFolderIdViewColumns"
        },
        {
            "name": "divide",
            "baseName": "divide",
            "type": "FolderFolderIdViewDivide"
        },
        {
            "name": "filters",
            "baseName": "filters",
            "type": "FolderFolderIdViewFilters"
        },
        {
            "name": "grouping",
            "baseName": "grouping",
            "type": "FolderFolderIdViewGrouping"
        },
        {
            "name": "name",
            "baseName": "name",
        ...
        },
        {
            "name": "parent",
            "baseName": "parent",
            "type": "ViewViewIdParent"
        },
        {
            "name": "settings",
            "baseName": "settings",
            "type": "FolderFolderIdViewSettings"
        },
        {
            "name": "sorting",
            "baseName": "sorting",
        ...
        {
            "name": "teamSidebar",
            "baseName": "team_sidebar",
            "type": "FolderFolderIdViewTeamSidebar"
        },
        {
            "name": "type",
            "baseName": "type",
    ...
    static getAttributeTypeMap() {
        return InlineObject42.attributeTypeMap;
    }
}
